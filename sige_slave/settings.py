"""
Django settings for sige_slave project.
...
LOGGING = {
    ...
    "formatters": {
        ...
        "middle": {"format": "%(asctime)s - %(levelname)-6s: %(message)s", "datefmt": "%d/%m/%Y-%H:%M:%S"},
        "verbose": {
            "format": "%(asctime)s: %(module)-12s: [line: %(lineno)-3s] %(message)s",
            "datefmt": "%d/%m/%Y-%H:%M:%S",
        },
    },
    "handlers": {
